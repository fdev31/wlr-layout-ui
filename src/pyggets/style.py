...
class Style:
    ...
    surface: tuple[int, ...] = (50, 50, 50)
    """Inner background for Panel and TextInput."""

    surface_text: tuple[int, ...] = (220, 220, 220, 255)
    """Text color inside TextInput and Tooltip."""

    placeholder_text: tuple[int, ...] = (120, 120, 120, 200)
    """TextInput placeholder text color."""

    knob_color: tuple[int, ...] = (255, 255, 255)
    """Toggle knob and Slider handle color."""

    shadow: tuple[int, ...] = (0, 0, 0, 80)
    """Widget / box drop-shadow color."""

    scrollbar: tuple[int, ...] = (180, 180, 180, 120)
    """ScrollBox scrollbar indicator color."""

    backdrop: tuple[int, ...] = (0, 0, 0, 150)
    """Modal semi-transparent backdrop color."""

    tooltip_bg: tuple[int, ...] = (40, 40, 40, 255)
    """Tooltip background color."""

    dropdown_bg: tuple[int, ...] = (100, 100, 100)
